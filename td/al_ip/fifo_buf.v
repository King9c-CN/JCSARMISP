 ...
 ** File	:	C:/Users/W1030/Desktop/m0/m0/td/al_ip/fifo_buf.v
 ** Date	:	2024 07 04
...
module fifo_buf #(parameter DATA_WIDTH_W = 8, 
    ...
    // =============================================
    ram_infer_fifo_buf #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module ram_infer_fifo_buf (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
