 ...
 ** File	:	C:/Users/W1030/Desktop/m0/rtl/al_ip/fifo_data.v
 ** Date	:	2024 04 28
...
module fifo_data #(parameter DATA_WIDTH_W = 32, 
    ...
    fifo_cross_domain_addr_process_al_fifo_data #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_fifo_data #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_fifo_data #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_fifo_data #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_fifo_data (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
